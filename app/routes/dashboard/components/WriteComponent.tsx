...
export default function WriteComponent() {
  ...
  return (
    <>
      {translationDone ? <div className="flex flex-col justify-center items-center w-full h-full bg-primary-100 rounded-lg shadow-md">
      ...
      <div className="translation_button flex flex-row items-center justify-center my-5 space-x-6">
        ...
        <button className="flex items-center justify-center border-2 rounded-md border-neutral-700 bg-primary-100 text-xs text-primary-900 py-2 px-6 hover" onClick={onSegmentsSubmit} disabled={targetSegment ==""}>Submit</button>
      </div>
    </div>
