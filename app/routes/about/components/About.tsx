  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="space-y-6">
        ...
        <p className="text-gray-700 text-sm font-monlam leading-loose">
          མཉམ་རུབ་ཀྱིས་མི་སྒེར་དང་ཚོགས་སྡེ་སུ་རུང་ལ་བོད་ཀྱི་རིག་གཞུང་སྲུང་སྐྱོབ་ཐད་ནུས་པ་འདོན་རྒྱུའི་ལམ་བུ་ཞིག་བཏོད་ཡོད།
          འདི་ནི་སྡིངས་ཆ་ཙམ་ཞིག་ག་ལ་ཡིན་ཏེ།
          འདི་འབྱུང་འགྱུར་བོད་ཀྱི་མི་རབས་གསར་པ་རྣམས་ཀྱི་ཆེད་དུ།
          རང་གི་སྐད་ཡིག་དང་གཏམ་རྒྱུད།
          སྲོལ་རྒྱུན་བཅས་གསོན་པོར་གནས་པར་བྱེད་པའི་མཉམ་འབྲེལ་གྱི་ལས་འགུལ་ཞིག་ཡིན།
          ང་ཚོས་མཉམ་རུབ་ཀྱིས་བོད་ཀྱི་རིག་གཞུང་འཛུགས་སྐྲུན་དང་མཉམ་སྤྱོད།
          ད་དུང་དར་སྤེལ་གཏོང་རྒྱུར་འབད་པར་བྱ།
        </p>
