...
export default function Quotation() {
  ...
  return (
    <div ref={fadeInRef} className="flex flex-col bg-white pl-10 pt-10 opacity-0 transition-opacity duration-1000 ease-in-out">
      ...
      <figure className="text-left relative w-fit ">
        ...
        <figcaption className="mt-2  text-sm font-medium text-primary-700 text-right absolute -right-1/4">
