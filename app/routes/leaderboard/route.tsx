...
export default function Dashboard() {
  return (
    <div className="grid grid-cols-10 grid-rows-3 px-3 md:px-10 pb-5 md:pb-2 gap-2 bg-primary-50 min-h-[calc(100vh-90px)]">
      ...
      <div className="row-span-2 col-span-full md:col-span-6 bg-white shadow-md inset-0 rounded-xl overflow-auto">
        <Table />
      </div>
      <EachContribution />
    </div>
