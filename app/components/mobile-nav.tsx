...
export function MobileNav({ isHomePage, isContributionsPage, isAboutPage, isLeaderboardPage }: MobileNavProps) {
        ...
        <div className="fixed inset-y-0 right-0 w-64 bg-secondary-700 shadow-lg transform transition-transform duration-300 ease-in-out z-50">
          <div className="flex flex-col h-full">
            <div className="flex justify-between items-center p-4 border-b border-blue-700">
              <Link to="/" onClick={handleNavigation} className="text-lg font-bold text-primary-50">Nyamrub</Link>
